# Fork of [CVPR2022] Thin-Plate Spline Motion Model for Image Animation. The purpose is too accelerate the reenactment process so that the inference can be made on cpu with less than a minute
