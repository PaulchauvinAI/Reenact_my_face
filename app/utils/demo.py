...
import torch
from app.modules.inpainting_network import InpaintingNetwork
from app.modules.keypoint_detector import KPDetector
from app.modules.dense_motion import DenseMotionNetwork
from app.modules.avd_network import AVDNetwork
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint",
        default="app/checkpoints/vox.pth.tar",
        help="path to checkpoint to restore",
    )

    parser.add_argument(
        "--source_image", default="./app/assets/source.png", help="path to source image"
    )
    parser.add_argument(
        "--driving_video",
        default="./app/assets/driving.mp4",
